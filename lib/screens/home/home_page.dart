...
import 'package:sliding_navbar/screens/home/widgets/genre.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    homeBloc.add(GetBannerListEvent());
  }
    ...
    return Scaffold(
      ...
      body: BlocConsumer<HomeBloc, HomeState>(
          listener: (context, state) {
            ...
            if (state is HomeBannerListResult) {
              isLoading = false;
        ...
        else if (state is HomeBannerListResult) {
          return Builder(
              builder: (context) {
                var banner = state.list;
                            ...
                            children: [
                              Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image:
                                    NetworkImage(
                                        banner[index].bannerImage.toString()),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                              ...
                              Positioned(
                                ...
                                child: Column(
                                  children: [
                                    Text(
                                      banner[index].title!.english.toString(),
                                    ...
                                    Text(
                                      banner[index].updatedAt.toString(),
                                      style: const TextStyle(
                                          color: Colors.white,
